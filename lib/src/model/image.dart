...
class Image {
  ...
  @override
  String toString() =>
      'Image[title=$title, thumbnail=$thumbnail, image=$image, description=$description]';
  ...
  static Image? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Image(
        ...
        image: Thumbnail.fromJson(json[r'image'])!,
        description: ImageDescription.fromJson(json[r'description']),
      );
    }
    return null;
  }
