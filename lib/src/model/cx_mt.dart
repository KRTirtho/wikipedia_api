...
class CxMt {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is CxMt && other.contents == contents;
  ...
  static CxMt? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CxMt[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CxMt[$key]" has a null value in JSON.');
        });
        return true;
      }());
