...
class CxDict {
  ...
  List<CxDictTranslationsInner> translations;
  ...
  int get hashCode =>
      ...
      (source_ == null ? 0 : source_!.hashCode) + (translations.hashCode);
  ...
  static CxDict? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CxDict[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CxDict[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CxDict(
        ...
        translations:
            CxDictTranslationsInner.listFromJson(json[r'translations']),
      );
    }
    return null;
  }
