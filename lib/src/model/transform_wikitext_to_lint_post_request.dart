...
class TransformWikitextToLintPostRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is TransformWikitextToLintPostRequest && other.wikitext == wikitext;
  ...
  static TransformWikitextToLintPostRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static Map<String, TransformWikitextToLintPostRequest> mapFromJson(
      dynamic json) {
