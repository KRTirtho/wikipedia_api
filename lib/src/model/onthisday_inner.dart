...
class OnthisdayInner {
  ...
  int get hashCode =>
      ...
      (text == null ? 0 : text!.hashCode) + (pages.hashCode);
  ...
  static OnthisdayInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "OnthisdayInner[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "OnthisdayInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
