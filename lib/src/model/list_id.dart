...
class ListId {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is ListId && other.id == id;
  ...
  static ListId? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ListId[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ListId[$key]" has a null value in JSON.');
        });
        return true;
      }());
