...
class ListRead {
  ...
  @override
  String toString() =>
      'ListRead[id=$id, name=$name, description=$description, created=$created, updated=$updated]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ListRead[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ListRead[$key]" has a null value in JSON.');
        });
        return true;
      }());
